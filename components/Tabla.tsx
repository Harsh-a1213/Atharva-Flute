        ...
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            {[
              {
                title: "Beginner",
                text: "Basic bols, posture, rhythm exercises, and coordination.",
              },
              {
                title: "Intermediate",
                text: "Taal clarity, layakari, and accompaniment techniques.",
              },
              {
                title: "Advanced",
                text: "Expressive rhythm, performance readiness, musical precision.",
              },
            ].map((stage, i) => (
              <div
                key={i}
