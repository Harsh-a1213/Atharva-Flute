...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Yes, our curriculum is designed from the ground up, and we start with the basics, even for first-time learners.',
  },
  {
    question: 'Can I switch between group and one-on-one classes later?',
    answer:
      'Yes, you can upgrade or switch your plan based on your comfort and learning pace anytime.',
  },
];
